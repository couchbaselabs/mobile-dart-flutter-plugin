...
abstract class Query {
  ...
  static SyncQuery fromN1qlSync(Object database, String query) =>
...
abstract class SyncQuery implements Query {
  ...
  factory SyncQuery.fromN1ql(Object database, String query) =>
      SyncQuery.fromN1ql(database, query);
  ...
  factory SyncQuery.fromJsonRepresentation(
    ...
    String json,
      ...
      SyncQuery.fromJsonRepresentation(database, json);
  ...
  @override
  Object addChangeListener(QueryChangeListener<SyncResultSet> listener);

  @override
  void removeChangeListener(Object token);
