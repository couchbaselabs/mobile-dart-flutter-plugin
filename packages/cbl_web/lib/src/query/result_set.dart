...
abstract class ResultSet {
  ...
  /// must not be used when using a stream.
  @experimental
  Stream<D> asTypedStream<D extends Object>();
  ...
  @experimental
  FutureOr<List<D>> allTypedResults<D extends Object>();
}
...
abstract class SyncResultSet
  ...
  @experimental
  Iterable<D> asTypedIterable<D extends Object>();
  ...
  @override
  @experimental
  List<D> allTypedResults<D extends Object>();
}
...
Object createResultSetMContext(Object database) => {};
